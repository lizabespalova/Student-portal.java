...
*/
            if(messagetext.equals(subjects.MATH.toString())||messagetext.equals(subjects.PROGRAMMING.toString())||
                ...
                if(!/*check_state*/customerRepository.findById(update.getCallbackQuery().getMessage().getChatId()).get().isCheck_state()){set_post(String.valueOf(chatID),0,update.getCallbackQuery().getMessage().getMessageId(),update.getCallbackQuery().getMessage()); set_last_buttons(String.valueOf(chatID));}
...
//
               ...
               /* *//*check_state*//* = true;*/
                ...
                if (!/*check_state*/customerRepository.findById(message.getChatId()).get().isCheck_state()) {
                ...
                if (!customerRepository.findById(message.getChatId()).get().isCheck_state()/*check_state*/) {
                    set_post(String.valueOf(message.getChatId()),0,message.getChatId(), message);
                    set_last_buttons(String.valueOf(message.getChatId()));
