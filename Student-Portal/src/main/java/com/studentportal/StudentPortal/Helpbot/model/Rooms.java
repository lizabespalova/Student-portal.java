...
public class Rooms {
    ...
    @Column(nullable=false,name = "following")//послідовність дій при закінченні угоди. Якщо 1, то перевіряти смс користувача щодо оцінки виконавця.Якщо 2,то видаляємо користуавача та просимо картку виконавця.Якщо 3 , то встановлюємо успішну угоду, видаляємо виконаця та звільняємо кімнату
